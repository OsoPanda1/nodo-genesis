...
/* ------------------------------------------------------------------ */
/* EFECTOS AMBIENTALES — portados de visitarealdelmonte (VisualEffects)*/
/* Librería autocontenida de efectos visuales para el Nodo Cero:      */
/* partículas de oro, niebla, parallax, aurora, orbes, contadores...   */
/* Solo depende de `motion` (framer-motion) y canvas 2D puro.          */
/* ------------------------------------------------------------------ */
