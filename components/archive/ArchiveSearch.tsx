...
export function ArchiveSearch({ initial, onSearch, total }: ArchiveSearchProps) {
  ...
  return (
    <form onSubmit={submit} className="rounded-3xl border border-[#c9d0d4]/60 bg-white/80 backdrop-blur-md p-5 shadow-[0_16px_50px_rgba(13,70,82,0.10)]">
      <div className="flex flex-col gap-3 md:flex-row md:items-center">
        <div className="relative flex-1">
          <Search className="absolute left-3.5 top-1/2 h-4 w-4 -translate-y-1/2 text-[#8a97a4]" />
          <input
            value={filters.q}
        ...
        <div className="flex items-center gap-2">
          <button
            type="submit"
            className="rounded-xl bg-[#0d4652] px-5 py-2.5 text-xs font-bold text-[#f2cc76] shadow-[0_8px_24px_rgba(13,70,82,0.25)] transition-all hover:shadow-[0_10px_32px_rgba(13,70,82,0.4)]"
          >
            Buscar
          </button>
          <button
            ...
            className={`rounded-xl border px-4 py-2.5 text-xs font-bold transition-all flex items-center gap-2 ${advanced ? 'border-[#0d4652] text-[#0d4652] bg-[#0d4652]/8' : 'border-[#c9d0d4] text-[#536b86] hover:text-[#082f3b]'}`}
          >
          ...
          {(filters.q || filters.assetType || filters.yearFrom || filters.yearTo) && (
            <button
              type="button"
              onClick={clear}
              className="rounded-xl p-2.5 text-[#8a97a4] hover:text-[#a9481e] transition-colors"
      ...
      {advanced && (
        <div className="mt-4 grid grid-cols-1 gap-3 border-t border-[#c9d0d4]/50 pt-4 sm:grid-cols-3">
          <div className="space-y-1.5">
            <label className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#0d4652]">Tipo de pieza</label>
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#0d4652]">Desde el año</label>
          ...
          <div className="space-y-1.5">
            <label className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#0d4652]">Hasta el año</label>
      ...
      {typeof total === 'number' && (
        <p className="mt-3 text-[11px] font-mono text-[#8a97a4]">
